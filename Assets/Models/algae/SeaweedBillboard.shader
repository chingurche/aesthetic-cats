Shader "Custom/SeaweedBillboard"
{
    Properties
    {
        ...
        // ДОБАВЛЕНО: Свойство для выбора цвета в инспекторе
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 _MainTex_ST;
            fixed _Cutoff;
            // ДОБАВЛЕНО: Объявление переменной для видеокарты
            fixed4 _Color; 
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                // ДОБАВЛЕНО: Умножаем цвет пикселя текстуры на выбранный тобой цвет
